                            ...
                            <div class="row ">
                                @foreach($settings as $setting)
                                    ...
                                    <div class="col-lg-12">
                                        <div class="mt-5 mt-lg-4">
                                            <div class="row mb-4">
                                                <label for="horizontal-Fullname-input{{$setting->name}}"
                                                       class="col-sm-4 col-form-label">@lang('back.'.$setting->name)</label>
                                                <div class="col-sm-8">
                                                        <input type="text" class="form-control"
                                                               id="horizontal-Fullname-input{{$setting->name}}" required
                                ...
                                @endforeach
                                    <div class="col-lg-12">
                                        <div class="mt-5 mt-lg-4">
                                            <div class="row mb-4">
                                                <label for="whatsapp" class="col-sm-4 col-form-label">{{$settingwahts->name}}</label>
                                                <div class="col-sm-8">
                                                    <textarea name="whatsapp"  id="whatsapp" class="form-control" cols="30" rows="10">{{old('value',$settingwahts->value)}}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
