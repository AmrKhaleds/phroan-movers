...
@section('title')
    @lang('back.create') @lang('back.maintenance')
@endsection
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0">@lang('back.create') @lang('back.maintenance')</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item active">@lang('back.create') @lang('back.maintenance')</li>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                                ...
                                <form method="post" action="{{route('maintenances.store')}}" class="custom-validation">
                                    @csrf
                                    <div class="row">
                                        <div class="col-lg-6">
                                                ...
                                                <div class="row mb-4">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="number" class="form-control" id="horizontal-Fullname-input"
                                                               value="{{old('cost_maintenance')}}" required
                                                    ...
                                                    <div class="col-sm-8">
                                                        <select name="vehicle_id" class="form-control" required>
                                                            ...
                                                            @foreach($vehicles as $vehicle)
                                                                <option value="{{$vehicle->id}}">{{$vehicle->car_name}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
