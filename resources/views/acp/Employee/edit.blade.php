                            ...
                            <div class="col-lg-6">
                                <div class="mt-5 mt-lg-4">
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-8">
                                            <select name="team_leader_id" class="form-control">
                                                <option value="">@lang('back.select_one')</option>
                                                <option {{$employee->employee->team_leader_id == 0 ? 'selected' : ''}}  value="0">@lang('back.team_leader')</option>
                                                <option {{$employee->employee->team_leader_id == 1 ? 'selected' : ''}}  value="1">@lang('back.general')</option>

                                                @foreach($team_leaders as $team_leader)
                                                    @if($team_leader->profile->team_leader_id == 0)
                                                        <option value="{{$team_leader->id}}" {{$employee->employee->team_leader_id == $team_leader->id ? 'selected'  : ''}} >{{$team_leader->name}}</option>
                                                    @endif
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="file" class="form-control" id="horizontal-Fullname-input"
                                                   name="national_id[]" multiple accept="image/*">
