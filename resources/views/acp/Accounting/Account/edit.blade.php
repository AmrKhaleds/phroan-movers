                                        ...
                                        <div class="col-sm-8">
                                            <select name="parent_account" id="emptyDropdown"
                                                ...
                                                @foreach($trees->where('parent_id','!=',0) as $parent)
                                                    <option value="{{$parent->id}}" {{$account->parent_id == $parent->parent_id ? 'selected' : ''}}>{{$parent->account_name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-8">
                                            <textarea class="summernote" placeholder="@lang('back.description')"
                                                      cols="40" rows="4" name="description">{{old('description',$account->note)}}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
