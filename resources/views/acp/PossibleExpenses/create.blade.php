...
@section('title')
    @lang('back.create') @lang('back.companies')
@endsection
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0">@lang('back.create') @lang('back.company')</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item active">@lang('back.create') @lang('back.company')</li>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <form method="post" action="{{route('companies.store')}}" class="custom-validation" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" required
                                                   id="horizontal-Fullname-input" value="{{old('name')}}"
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" required
                                                   id="horizontal-Fullname-input" value="{{old('phone')}}"
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" required
                                                   id="horizontal-Fullname-input" value="{{old('address')}}"
                                ...
                                <div class="col-lg-6">
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" required
                                                   id="horizontal-Fullname-input" value="{{old('manger')}}"
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" required
                                                   id="horizontal-Fullname-input" value="{{old('whatsapp')}}"
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="file" class="form-control" required id="horizontal-Fullname-input" name="logo">
                                        </div>
                                    </div>
