...
@section('title')
    @lang('back.create') @lang('back.worker')
@endsection
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0">@lang('back.create') @lang('back.worker')</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item active">@lang('back.create') @lang('back.worker')</li>
        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="post" action="{{route('workers.store')}}?parent={{$request->parent}}" class="custom-validation">
                        @csrf
                        <div class="row">
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-sm-8">
                                                <select class="form-control" name="job_type" required>
                                                    ...
                                                    <option value="HVAC_technician">@lang('back.HVAC_technician')</option>
                                                    <option value="carpenter">@lang('back.carpenter')</option>
                                                    <option value="wrapping">@lang('back.wrapping')</option>
                                                    <option value="workers">@lang('back.workers')</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
