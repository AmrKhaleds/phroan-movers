    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0">@lang('back.set_payroll')</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item active">@lang('back.set_payroll')</li>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                                ...
                                <form method="post" action="{{route('payrolls.store')}}" class="custom-validation">
                                    @csrf
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="mt-5 mt-lg-4">
                                                ...
                                                <div class="row mb-4">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <textarea placeholder="@lang('back.reason')" id="reason" name="reason" required class="form-control" cols="30" rows="5">{{old('reason')}}</textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row mb-4">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <select name="payroll_type" class="form-control select2" id="payroll_type" required>
                                                            <option value="">@lang('back.select_one')</option>
                                                            <option value="deduction">@lang('back.deduction')</option>
                                                            <option value="reward">@lang('back.reward')</option>
                                                        </select>
                                                    </div>
                                                </div>
